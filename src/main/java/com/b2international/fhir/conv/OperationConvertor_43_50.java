...
public class OperationConvertor_43_50 {
	...
	public static com.b2international.fhir.r4b.operations.BaseParameters convert(com.b2international.fhir.r5.operations.BaseParameters parameters) {
		if (parameters instanceof com.b2international.fhir.r5.operations.CodeSystemLookupParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.CodeSystemLookupResultParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.CodeSystemSubsumptionParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.CodeSystemSubsumptionResultParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.CodeSystemValidateCodeParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.CodeSystemValidateCodeResultParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.ConceptMapTranslateParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.ValueSetExpandParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.ValueSetValidateCodeParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.ValueSetValidateCodeResultParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.LoadPackageParameters r5Parameters) {
			return convert(r5Parameters);
		} else if (parameters instanceof com.b2international.fhir.r5.operations.LoadPackageResultParameters r5Parameters) {
			return convert(r5Parameters);
		} else {
	...
	public static com.b2international.fhir.r4b.operations.CodeSystemLookupParameters convert(com.b2international.fhir.r5.operations.CodeSystemLookupParameters parameters) {
		return new com.b2international.fhir.r4b.operations.CodeSystemLookupParameters()
			...
			.setProperty(parameters.getProperty() == null ? null : parameters.getProperty().stream()
					.map(OperationConvertor_43_50::convertType)
					.toList())
		;
	}
	...
	public static com.b2international.fhir.r4b.operations.CodeSystemLookupResultParameters convert(com.b2international.fhir.r5.operations.CodeSystemLookupResultParameters parameters) {
		return new com.b2international.fhir.r4b.operations.CodeSystemLookupResultParameters()
			...
			.setDesignation(parameters.getDesignation() == null ? null : parameters.getDesignation().stream()
					.map(OperationConvertor_43_50::convert)
					.toList())
			.setProperty(parameters.getProperty() == null ? null : parameters.getProperty().stream()
					.map(OperationConvertor_43_50::convert)
					.toList())
	...
	private static com.b2international.fhir.r4b.operations.CodeSystemLookupResultParameters.Property convert(com.b2international.fhir.r5.operations.CodeSystemLookupResultParameters.Property property) {
		return new com.b2international.fhir.r4b.operations.CodeSystemLookupResultParameters.Property()
			...
			.setSubProperty(property.getSubProperty() == null ? null : property.getSubProperty().stream().map(OperationConvertor_43_50::convert).toList())
		;
	}
	...
	public static com.b2international.fhir.r4b.operations.ConceptMapTranslateParameters convert(com.b2international.fhir.r5.operations.ConceptMapTranslateParameters parameters) {
		return new com.b2international.fhir.r4b.operations.ConceptMapTranslateParameters()
			...
			.setConceptMapVersion(convertType(parameters.getVersion()))
			
			// code in R4b is sourceCode in R5
			.setCode(convertType(parameters.getSourceCode()))
			
			.setSystem(convertType(parameters.getSystem()))
			.setVersion(convertType(parameters.getVersion()))
			
			// source in R4b is sourceScope in R5
			...
			// target in R4b is targetScope in R5
	...
	private static com.b2international.fhir.r4b.operations.ConceptMapTranslateParameters.Dependency convert (com.b2international.fhir.r5.operations.ConceptMapTranslateParameters.Dependency r5Dependency) {
		...
		if (r5Dependency.getValue() != null) {
			if (r5Dependency.getValue() instanceof org.hl7.fhir.r5.model.Coding) {
				r4bDependency.setConcept(convertType(r5Dependency.getValue()));
			} else {
	...
	public static com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters convert(com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters parameters) {
		return new com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters()
			.setResult(convertType(parameters.getMessage()))
			.setMessage(convertType(parameters.getMessage()))
			.setMatch(parameters.getMatch().stream().map(OperationConvertor_43_50::convert).toList())
		;
	}
	...
	private static com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters.Match convert(com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters.Match r5Match) {
		...
		return new com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters.Match()
			.setEquivalence(ConceptMapRelationshipConverter.convert(r5Relationship))
			.setConcept(convertType(r5Match.getConcept()))
			.setProduct(r5Match.getProduct() == null ? null : r5Match.getProduct().stream().map(OperationConvertor_43_50::convert).toList())
	...
	public static com.b2international.fhir.r4b.operations.ValueSetExpandParameters convert(com.b2international.fhir.r5.operations.ValueSetExpandParameters parameters) {
		return new com.b2international.fhir.r4b.operations.ValueSetExpandParameters()
			...
			.setDesignation(parameters.getDesignation() == null ? null : parameters.getDesignation().stream().map(OperationConvertor_43_50::convertType).toList())
			...
			.setDisplayLanguage(convertType(parameters.getDisplayLanguage()))
			.setExcludeSystem(parameters.getExcludeSystem() == null ? null : parameters.getExcludeSystem().stream().map(OperationConvertor_43_50::convertType).toList())
			.setSystemVersion(parameters.getSystemVersion() == null ? null : parameters.getSystemVersion().stream().map(OperationConvertor_43_50::convertType).toList())
			.setCheckSystemVersion(parameters.getCheckSystemVersion() == null ? null : parameters.getCheckSystemVersion().stream().map(OperationConvertor_43_50::convertType).toList())
			.setForceSystemVersion(parameters.getForceSystemVersion() == null ? null : parameters.getForceSystemVersion().stream().map(OperationConvertor_43_50::convertType).toList())
	...
	// $load-package input parameters
	public static com.b2international.fhir.r4b.operations.LoadPackageParameters convert(com.b2international.fhir.r5.operations.LoadPackageParameters parameters) {
		return new com.b2international.fhir.r4b.operations.LoadPackageParameters()
			.setName(convertType(parameters.getName()))
			.setVersion(convertType(parameters.getVersion()))
			.setRegistry(convertType(parameters.getRegistry()))
			.setResolveDependencies(convertType(parameters.getResolveDependencies()))
			.setResourceUrl(parameters.getResourceUrl() == null ? null : parameters.getResourceUrl().stream().map(OperationConvertor_43_50::convertType).toList())
		;
	}
	
	// $load-package output parameters
	public static com.b2international.fhir.r4b.operations.LoadPackageResultParameters convert(com.b2international.fhir.r5.operations.LoadPackageResultParameters parameters) {
		return new com.b2international.fhir.r4b.operations.LoadPackageResultParameters()
			.setSuccess(convertType(parameters.getSuccess()))
			.setNumberOfLoadedCodeSystems(convertType(parameters.getNumberOfLoadedCodeSystems()))
			.setNumberOfLoadedValueSets(convertType(parameters.getNumberOfLoadedValueSets()))
			.setNumberOfLoadedConceptMaps(convertType(parameters.getNumberOfLoadedConceptMaps()))
		;
	}
	...
	public static com.b2international.fhir.r5.operations.BaseParameters convert(com.b2international.fhir.r4b.operations.BaseParameters parameters) {
		if (parameters instanceof com.b2international.fhir.r4b.operations.CodeSystemLookupParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.CodeSystemLookupResultParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.CodeSystemSubsumptionParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.CodeSystemSubsumptionResultParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.CodeSystemValidateCodeParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.CodeSystemValidateCodeResultParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.ConceptMapTranslateParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.ValueSetExpandParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.ValueSetValidateCodeParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.ValueSetValidateCodeResultParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.LoadPackageParameters r4bParameters) {
			return convert(r4bParameters);
		} else if (parameters instanceof com.b2international.fhir.r4b.operations.LoadPackageResultParameters r4bParameters) {
			return convert(r4bParameters);
		} else {
			throw new FHIRFormatError(String.format("Unable to convert R4B parameters '%s' to R5.", parameters.getClass().getSimpleName()));
		}
	}
	...
	public static com.b2international.fhir.r5.operations.ConceptMapTranslateParameters convert(com.b2international.fhir.r4b.operations.ConceptMapTranslateParameters parameters) {
		...
		if (parameters.getReverse() != null && parameters.getReverse().getValue()) {
			...
			r5params
				// sourceCode in R5 is code in R4b
				.setSourceCode(convertType(parameters.getCode()))
				
				.setSystem(convertType(parameters.getSystem()))
				.setVersion(convertType(parameters.getVersion()))
				
				// sourceScope in R5 is source in R4b
				...
				// targetScope in R5 is target in R4b
	...
	private static com.b2international.fhir.r5.operations.ConceptMapTranslateParameters.Dependency convert (com.b2international.fhir.r4b.operations.ConceptMapTranslateParameters.Dependency r4bdependency) {
		return new com.b2international.fhir.r5.operations.ConceptMapTranslateParameters.Dependency()
			.setAttribute(convertType(r4bdependency.getElement()))
			.setValue(convertType(r4bdependency.getConcept()))
		;
	}
	...
	public static com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters convert(com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters parameters) {
		return new com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters()
			.setResult(convertType(parameters.getResult()))
			.setMessage(convertType(parameters.getMessage()))
			.setMatch(parameters.getMatch() == null ? null : parameters.getMatch().stream().map(OperationConvertor_43_50::convert).toList())
		;
	}
	...
	private static com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters.Match convert(com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters.Match r4bMatch) {
		var r4Equivalence = org.hl7.fhir.r4.model.codesystems.ConceptMapEquivalence.fromCode(r4bMatch.getEquivalence().getCode());
		...
		return new com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters.Match()
			...
			.setConcept(convertType(r4bMatch.getConcept()))
			.setProduct(r4bMatch.getProduct() == null ? null : r4bMatch.getProduct().stream().map(OperationConvertor_43_50::convert).toList())
			.setOriginMap(convertType(r4bMatch.getSource()))
		;
	}
	...
	private static com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters.Match.Product convert(com.b2international.fhir.r4b.operations.ConceptMapTranslateResultParameters.Match.Product r4bProduct) {
		return new com.b2international.fhir.r5.operations.ConceptMapTranslateResultParameters.Match.Product()
			.setAttribute(convertType(r4bProduct.getElement()))
			.setValue(convertType(r4bProduct.getConcept()))
		;
	}
	...
	// $load-package input parameters
	public static com.b2international.fhir.r5.operations.LoadPackageParameters convert(com.b2international.fhir.r4b.operations.LoadPackageParameters parameters) {
		return new com.b2international.fhir.r5.operations.LoadPackageParameters()
			.setName(convertType(parameters.getName()))
			.setVersion(convertType(parameters.getVersion()))
			.setRegistry(convertType(parameters.getRegistry()))
			.setResolveDependencies(convertType(parameters.getResolveDependencies()))
	...
	// $load-package output parameters
	public static com.b2international.fhir.r5.operations.LoadPackageResultParameters convert(com.b2international.fhir.r4b.operations.LoadPackageResultParameters parameters) {
		return new com.b2international.fhir.r5.operations.LoadPackageResultParameters()
			.setSuccess(convertType(parameters.getSuccess()))
			.setNumberOfLoadedCodeSystems(convertType(parameters.getNumberOfLoadedCodeSystems()))
			.setNumberOfLoadedValueSets(convertType(parameters.getNumberOfLoadedValueSets()))
			.setNumberOfLoadedConceptMaps(convertType(parameters.getNumberOfLoadedConceptMaps()))
